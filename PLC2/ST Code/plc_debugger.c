...
{&(RES0__INSTANCE0.DOSER_YELLOW), BOOL_ENUM},
...
{&(RES0__INSTANCE0.UNDERFLOWT2), BOOL_ENUM},
{&(RES0__INSTANCE0.STAGE), INT_ENUM},
{&(RES0__INSTANCE0.DESIREDDISTANCEFILL), INT_ENUM},
{&(RES0__INSTANCE0.DESIREDDISTANCEMIN), INT_ENUM},
{&(RES0__INSTANCE0.MINBLUE), INT_ENUM},
{&(RES0__INSTANCE0.DOSERYELLOWTIMER.EN), BOOL_ENUM},
{&(RES0__INSTANCE0.DOSERYELLOWTIMER.ENO), BOOL_ENUM},
{&(RES0__INSTANCE0.DOSERYELLOWTIMER.IN), BOOL_ENUM},
{&(RES0__INSTANCE0.DOSERYELLOWTIMER.PT), TIME_ENUM},
{&(RES0__INSTANCE0.DOSERYELLOWTIMER.Q), BOOL_ENUM},
{&(RES0__INSTANCE0.DOSERYELLOWTIMER.ET), TIME_ENUM},
{&(RES0__INSTANCE0.DOSERYELLOWTIMER.STATE), SINT_ENUM},
{&(RES0__INSTANCE0.DOSERYELLOWTIMER.PREV_IN), BOOL_ENUM},
{&(RES0__INSTANCE0.DOSERYELLOWTIMER.CURRENT_TIME), TIME_ENUM},
{&(RES0__INSTANCE0.DOSERYELLOWTIMER.START_TIME), TIME_ENUM},
