...
# Define the labels
dic_labels = ["treatmentComplete", "UnderFlowT2"]
doc_labels = ["Pump301", "Valve301"]
ir_labels = ["RangeSensor301", "FlowRate301"]
hr_labels = ["MaxDistanceFill"]
...
def add_labels(data):
    for item in data:
        ...
        item["DIC"] = {label: value for label, value in zip(dic_labels, item["DIC"])}
...
input_folder = "C:\\Users\\tardi\\OneDrive\\Documents\\Visual Studio Code Repos\\Python\\CPSWaterTestBench\\PLC3_Traces"

# Specify the output folder where modified JSON files will be saved
output_folder = "C:\\Users\\tardi\\OneDrive\\Documents\\Visual Studio Code Repos\\Python\\CPSWaterTestBench\\PLC3_Traces_Modified"
