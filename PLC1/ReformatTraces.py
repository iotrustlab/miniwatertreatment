...
# Define the labels
doc_labels = ["Pump101"]
ir_labels = ["FlowRate101", "RangeSensor101"]
...
def add_labels(data):
    for item in data:
        ...
        item["HR"] = {label: value for label, value in zip(hr_labels, item["HR"][:len(hr_labels)])}
    return data
...
input_folder = "C:\\Users\\tardi\\OneDrive\\Documents\\Visual Studio Code Repos\\Python\\CPSWaterTestBench\\PLC1_Traces"

# Specify the output folder where modified JSON files will be saved
output_folder = "C:\\Users\\tardi\\OneDrive\\Documents\\Visual Studio Code Repos\\Python\\CPSWaterTestBench\\PLC1_Traces_Modified"
